 ...
 * Description: Complete WordPress integration with Amazon Cognito - handles JWT/OIDC authentication and one-way (WC -> MyBosun) tenant-aware user synchronization.
 * Version: 3.0.5
 * Author: Adam Scott
...
define( 'WP_COGNITO_AUTH_VERSION', '3.0.5' );
